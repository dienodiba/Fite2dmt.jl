...
function CalculateObjectiveFunctionRhoaPhase(RMSd1::Vector, RMSd4::Vector, Phid1::Vector, Phid4::Vector, Phi::Vector, RMS::Vector, Stab::Vector, Psi::Vector, N::Integer, itr::Integer, nper::Integer, nst::Integer, dcale1::Matrix, dcalh::Matrix, dobs::Vector, W::Matrix, T::Vector, lambda::Number, m::Vector, K::Any, idd1::Integer, idd4::Integer)
    ...
    RMS[itr] = sqrt((RMSd1[itr]+RMSd4[itr])/(idd1+idd4))
    # Calculate individual RMS
    RMSd1[itr] = sqrt(RMSd1[itr]/idd1)
    RMSd4[itr] = sqrt(RMSd4[itr]/idd4)

    return dcal,RMSd1,RMSd4,Phid1,Phid4,Phi,RMS,Stab,Psi
end
