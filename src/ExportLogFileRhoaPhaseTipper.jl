# Dieno Diba 2024
# FITE2DMT
# Export log for rhoa phase tipper inversion

function ExportLogFileRhoaPhaseTipper(outroot::Any, filedat::String, filem0::String, filestg::String, filetopo::String, epoch::Integer, idd1::Integer, idd2::Integer, idd4::Integer, M::Integer, t1::Number, t2::Number, Phi::Vector, Psi::Vector, Stab::Vector, lambda::Number, RMS::Vector, RMSd1::Vector, RMSd2::Vector, RMSd4::Vector, runtime::Vector)
