# Dieno Diba 2024
# FITE2DMT
# Calculate TE mode tipper at the stations

function CalculateResponseFunctionsTETipper(idp::Integer, dcale2::Matrix, nno::Integer, nst::Integer, no2yz::Matrix, ns1e::Vector, ns2e::Vector, nbse::Vector, omega::Number, mu0::Number, ve::Vector)
